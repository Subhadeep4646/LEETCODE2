    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            <div className="mb-6 text-center">
                <h1 className="text-4xl font-extrabold text-gray-800"> Video Upload and Delete</h1>
                            ...
                            <tr key={problem._id} className="hover:bg-gray-50 transition">
                                ...
                                <td className="p-3 text-center">
                                    <button
                                        ...
                                        className="btn btn-sm btn-success flex items-center gap-1 hover:scale-105 transition-transform"
                                    >
                                        <Video size={16} />
                                        Upload
                                    </button>
