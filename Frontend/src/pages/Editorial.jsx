...
const Editorial = ({ description, secureUrl, thumbnailUrl, duration }) => {
    ...
    return (
        <>
            {secureUrl && thumbnailUrl && duration && (<div
            ...
            {(duration) && <div className='text-2xl mt-5'>Here is the Editorial for {description}</div>}
            {!(duration) && <div className='text-2xl mt-5'>Solution will be uploaded soon...</div>}
        </>
